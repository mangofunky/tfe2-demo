...
module "tfstate-functions" {
  source = "./sentinel/common-functions/tfstate-functions/tfstate-functions.sentinel"
}

module "tfconfig-functions" {
  source = "./sentinel/common-functions/tfconfig-functions/tfconfig-functions.sentinel"
}

module "aws-functions" {
  source = "./sentinel/aws/aws-functions/aws-functions.sentinel"
}
...
policy "restrict-ingress-sg-rule-rdp" {
  source = "./sentinel/aws/restrict-ingress-sg-rule-rdp.sentinel"
  enforcement_level = "hard-mandatory"
}
